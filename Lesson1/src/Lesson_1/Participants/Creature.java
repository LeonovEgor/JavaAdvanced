...
public abstract class Creature implements Competitor {
    ...
    public Creature(String type, String name, int maxRunDistance, int maxJumpHeight, int maxSwimDistance) {
        this.type = type;
        this.name = name;
    ...
    @Override
    public String info() {
        return type + " " + name + " - " + (onDistance? "На дистанции": "Сошел с дистанции");
    }
}